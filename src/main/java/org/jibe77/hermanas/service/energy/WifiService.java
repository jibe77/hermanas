...
public class WifiService {
    ...
    public WifiService(ProcessLauncher processLauncher, ConsumptionModeController consumptionModeController, DoorService doorService, EmailService emailService) {
