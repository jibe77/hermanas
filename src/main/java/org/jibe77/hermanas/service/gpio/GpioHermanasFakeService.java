...
import org.jibe77.hermanas.service.gpio.DefaultGpioPinDigitalInput;
import org.jibe77.hermanas.service.gpio.DefaultGpioPinDigitalOutput;
...
@Profile("gpio-fake")
public class GpioHermanasFakeService implements GpioHermanasService {

    private static final Logger logger = LoggerFactory.getLogger(GpioHermanasFakeService.class);
