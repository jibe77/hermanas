...
public class CameraPromptBuilder {
    ...
    public static final String DEFAULT_PROMPT =
            ...
            + " At the end of this line, append one 🐔 emoji per chicken you counted"
            + " (0 chicken → no emoji).\n"
            ...
            + " At the end of this line, append one 🥚 emoji per egg you counted"
            + " (0 egg → no emoji).\n"
            ...
            + " the door itself)."
            + " At the end of this line, append exactly one door emoji: 🚪 if closed,"
            + " or 🚪‍⭐ (door with a sparkle) if opened. Only one emoji.\n"
            + "*   is there poop / dirt on the floor ? (grade from 1 to 5)."
            + " At the end of this line, append poop emojis 💩 to visualize the dirt"
            + " level, using this exact mapping: grade 1 or 2 → one 💩,"
            + " grade 3 → two 💩💩, grade 4 or 5 → three"
            + " 💩💩💩. Never emit more than three.\n"
